---
description: Phân tích requirement document (.docx/.pdf/.xlsx/.csv/.xml, user story) — sinh tài liệu phân tích chi tiết, KHÔNG sinh test cases.
skills:
...
- User cung cấp requirement document (`.doc`, `.docx`, `.pdf`, `.xlsx`, `.csv`, `.xml`, `.md`) và yêu cầu "phân tích"
