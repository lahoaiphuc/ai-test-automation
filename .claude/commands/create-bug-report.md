---
description: Sinh bug report chuẩn từ test FAIL — thu thập evidence, viết steps to reproduce, phân loại severity/priority. Tùy chọn đẩy lên Google Sheet.
skills:
  - skills-bug-reporter
...
- Đẩy lên Google Sheet chỉ khi user xác nhận nội dung bug report
...
2. **⏸️ DỪNG LẠI** — trình bày cho user review, hỏi: "Nội dung bug report đã chính xác chưa? Có cần đẩy lên Google Sheet không?"
