...
description: Skill sinh bug report chuẩn từ test FAIL — tự thu thập evidence (screenshot, log, environment), viết steps to reproduce, phân loại severity/priority, và hỗ trợ đẩy lên Google Sheet.
---

# Bug Reporter

Purpose: Chuyển kết quả test FAIL thành bug report chuẩn, đầy đủ evidence, sẵn sàng gửi developer hoặc đẩy lên Google Sheet.
